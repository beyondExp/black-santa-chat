  ...
  <div v-if="showModal" class="modal">
    <div class="modal-content">
      ...
      <div class="tab-buttons">
        <Button variant="ghost" :class="{ active: activeTab === 'monthly' }" @click="setActiveTab('monthly')">Monatlich</Button>
        <Button variant="ghost" :class="{ active: activeTab === 'one-time' }" @click="setActiveTab('one-time')">Einmalig</Button>
      </div>
